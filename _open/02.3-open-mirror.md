...
The final step after making the mirror is to mount it properly. A huge majority of RoboCup teams mount their mirrors using a clear acrylic tube. However, we did not want to use this method becuase
...
At about the same time, we noticed that the 2 long copper stands that suppored the handle were starting to bend. As such we decided to make a 4 point connection for the handle and use those 4 points to hold up the mirror plate!

IMAGE OF NEW MOUNT

But then, after a month or so, we realised that the mirror plate was starting to sag under the weight of the mirror. To fix this, the mirror plate was thickened from 2 mm to 3 mm and an additional 4 stands extending from the trapezium mounts gave the mirror plate the support it needed. These 4 stands aligned perfectly with the 4 copper stands for the handle, and with that, our current 8 point support structure was born.

IMAGE OF CURRENT MOUNT

dont forget mounting hub,single vs double and mirror plate design