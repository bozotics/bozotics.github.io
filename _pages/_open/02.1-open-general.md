...
It is clear that the robot was able to change its motors' directions almost immediately upon detecting the white line. However, since it had a higher CG, when the braking force is applied, the turning moment about the front side of the base of the robot is larger. This increases the likelihood of the back wheels lifting up slightly, losing traction and skidding pretty badly. This "wheel-lifting" problem is especially obvious in the second part of the video.
