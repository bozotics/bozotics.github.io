...
Our robot is quite modular in terms of the sectioning of different layers. Each layer can be assembled individually, before bringing it all together. The image below shows the main sections (from left to right): handle, mirror, camera module, 3rd layer PCB, 2nd layer carbon fibre plate, 1st layer PCB.
